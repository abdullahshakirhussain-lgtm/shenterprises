        ...
        <header className="bg-brand-900 text-white sticky top-0 z-40">
          <div className="container-x flex items-center gap-4 py-3">
            ...
            <nav className="flex flex-wrap gap-3 text-sm ml-2">
              ...
              <Link href="/admin/ai-tools" className="hover:text-brand-200">AI Tools</Link>
              <Link href="/admin/ai-insights" className="hover:text-brand-200">AI Insights</Link>
              <Link href="/admin/profiles" className="hover:text-brand-200">Profiles</Link>
            </nav>
